...
var swiper2 = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__["default"](".swiper2", {
  loop: true,
  centeredSlides: true,
  slidesPerView: "auto",
  slidesPerGroup: 3,
...
var toggle_button = document.querySelector('[area-toggle]');
var area_mainmenu = document.querySelector('#area-mainmenu');
...
window.addEventListener('resize', function () {
  if (deviceWidth < 320) {
    var toggler = this.document.querySelector('#toggler');
